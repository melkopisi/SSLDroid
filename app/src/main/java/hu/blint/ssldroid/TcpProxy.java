...
public class TcpProxy {
  ...
  public TcpProxy(String tunnelName, int listenPort, String targetHost, int targetPort,
  ...
  public void serve() throws IOException {
    server =
        new TcpProxyServerThread(this.tunnelName, this.listenPort, this.tunnelHost, this.tunnelPort,
            this.keyFile, this.keyPass);
    server.start();
  }
  ...
  public void stop() {
    ...
    Log.d("SSLDroid",
        "Stopping tunnel " + this.listenPort + ":" + this.tunnelHost + ":" + this.tunnelPort);
  }
